...
public class NodeBasedEditor : EditorWindow
{
    ...
    private void OnClickAddNode(Vector2 mousePosition)
    {
        ...
        nodes.Add(new Node(mousePosition, 200, 100, nodeStyle, selectedNodeStyle, inPointStyle, outPointStyle, OnClickInPoint, OnClickOutPoint, OnClickRemoveNode, nodeCount, false, 0, null));
    ...
    private void LoadSkillCreateNode(Skill skill, Vector2 position)
    {
        ...
        nodes.Add(new Node(position, 200, 100, nodeStyle, selectedNodeStyle, inPointStyle, outPointStyle, OnClickInPoint, OnClickOutPoint, OnClickRemoveNode, skill.id_Skill, skill.unlocked, skill.cost, skill.skill_Dependencies));
